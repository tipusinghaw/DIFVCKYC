...
const FinancialServices = () => {
  ...
  const handleVerifyCredentials = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5003/crossmint/verify-credential', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Apply for Loan</h2>
            <p className="text-gray-600">Get financial assistance with easy loan options.</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Apply for Credit Card</h2>
            <p className="text-gray-600">Enjoy spending freedom with our credit card options.</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Apply for Debit Card</h2>
            <p className="text-gray-600">Secure and convenient access to your funds.</p>
          </div>
        </div>
        ...
        >
          <FaMoneyCheck className="text-blue-600 text-4xl animate-bounce" />
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Account Opening</h2>
            <p className="text-gray-600">Secure and convenient access to your funds.</p>
          </div>
        </div>
        ...
        >
          <FaMoneyCheck className="text-blue-600 text-4xl animate-bounce" />
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Account Recovery</h2>
            <p className="text-gray-600">Secure and convenient access to your funds.</p>
          </div>
        </div>
        ...
        >
          <FaMoneyCheck className="text-blue-600 text-4xl animate-bounce" />
          <div className="flex flex-col">
            <h2 className="text-xl font-semibold text-gray-800">Subscription services</h2>
            <p className="text-gray-600">Secure and convenient access to your funds.</p>
          </div>
        </div>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white rounded-lg shadow-lg p-8 w-[600px] h-auto flex flex-col items-center">
      ...
      />
      <h2 className="text-3xl font-bold text-blue-600 mb-2">{details?.name}</h2>
      <p className="text-gray-700 text-sm italic mb-6">Raigarh, Maharashtra, India</p>
